  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      switch (method) {
        ...
        case 'transfer':
          sessionStorage.setItem("pay_items", JSON.stringify(orderItems));
          sessionStorage.setItem("pay_address", JSON.stringify(formData));
          sessionStorage.setItem("pay_amount", totalAmount);

          const initResponse = await axios.post(serverUrl + '/api/payment/initiate', {
          ...
          if (initResponse.data.success) {
            ...
            toast.error(initResponse.data.message || 'PAyment initiation failed')
          }
